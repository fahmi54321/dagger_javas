...
import com.example.dagger_java.screens.questionslistviewmodel.QuestionsListViewModelActivity;
...
public interface PresentationComponent {
    ...
    void inject(QuestionsListViewModelActivity questionsListViewModelActivity);
}
