...
public class QuestionsListView extends BaseViewMvc<QuestionsListView.Listener> {
    ...
    public QuestionsListView(LayoutInflater layoutInflater, ViewGroup viewGroup) {
